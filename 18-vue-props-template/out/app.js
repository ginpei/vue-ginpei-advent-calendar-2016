  ...
  data: function () {
    return {
      users: [
        { name: 'Alice', age: 11 },
        { name: 'Bob', age: 22 },
        { name: 'Charlie', age: 'thirty-three' }  // Oops!
      ]
    }
  }
}
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5596cc67", __vue__options__)
  } else {
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._c;return _c('li',[_vm._v(_vm._s(_vm.name)+" is "+_vm._s(_vm.age)+" years old.")])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4ebc15a8", __vue__options__)
  } else {
    hotAPI.reload("data-v-4ebc15a8", __vue__options__)
  }
})()}
